...
def upgrade() -> None:
    ...
    op.create_index(
        op.f("ix_department_categories_issue_category"),
        "department_categories",
        ["issue_category"],
        unique=False,
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "urgency",
            sa.Enum("LOW", "MEDIUM", "HIGH", "CRITICAL", name="urgency_level", native_enum=False),
    ...
    op.create_index(
        op.f("ix_agent_executions_agent_name"), "agent_executions", ["agent_name"], unique=False
    )
    op.create_index(
        op.f("ix_agent_executions_report_id"), "agent_executions", ["report_id"], unique=False
    )
    op.create_index(
        op.f("ix_agent_executions_status"), "agent_executions", ["status"], unique=False
    )
    op.create_index(
        op.f("ix_agent_executions_workflow_id"), "agent_executions", ["workflow_id"], unique=False
    )
    ...
    op.create_index(
        op.f("ix_assignments_department_id"), "assignments", ["department_id"], unique=False
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "priority",
            sa.Enum(
                "LOW", "NORMAL", "HIGH", "CRITICAL", name="notification_priority", native_enum=False
            ),
        ...
        sa.Column(
            "channel",
            sa.Enum(
                "PUSH", "SMS", "EMAIL", "IN_APP", name="notification_channel", native_enum=False
            ),
    ...
    op.create_index(
        op.f("ix_notifications_citizen_id"), "notifications", ["citizen_id"], unique=False
    )
    op.create_index(
        op.f("ix_notifications_delivery_status"), "notifications", ["delivery_status"], unique=False
    )
    op.create_index(
    ...
    op.create_index(
        op.f("ix_reward_transactions_citizen_id"),
        "reward_transactions",
        ["citizen_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_reward_transactions_reason"), "reward_transactions", ["reason"], unique=False
    )
    op.create_index(
        op.f("ix_reward_transactions_report_id"), "reward_transactions", ["report_id"], unique=False
    )
